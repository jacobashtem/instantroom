export const messages = {
  pl: {
    ...
    navigation: {
      ...
      create: "Twórz",
      recentVisualizations: "Ostatnie wizualizacje",
      loggedInAs: "Zalogowany jako",
      unknownUser: "Nieznany użytkownik",
      tokenCount: "Liczba tokenów:",
      profileAndSubscription: "Profil & Subskrypcja",
      logout: "Wyloguj",
      subscriptionActiveUntil: "Subskrypcja aktywna do:",
      subscriptionCancelledExpires: "Subskrypcja została anulowana – wygaśnie:",
    },
    generationProgress: {
      generating: "Trwa generowanie",
      your: "Twojej",
      yourPlural: "Twoich",
      visualizations: "wizualizacji...",
      currentStatus: "Obecny status to:",
      visualizing: "Wizualizowanie...",
      interrupted: "Przerwano",
      warmup: "Rozgrzewka...",
      andItTakes: "I trwa już:",
      warmupDescription: "według niektórych, to najważniejszy element treningu. Dla naszego modelu AI również, bo",
      warmupImportant: "zajmuje aż około 95% całego czasu!",
      warmupWait: "Zwykle potrwa od kilku sekund, do nawet 5-10 minut. Wystarczy cierpliwie poczekać!",
      visualizingDescription: "rozpoczyna się zaraz po rozgrzewce i potrwa już tylko kilkanaście sekund.",
      interruptedDescription: "generowanie wizualizacji. Spokojnie, nie pobierzemy tokenów! Spróbuj ponownie za chwilę.",
      startOver: "Zacznij od nowa",
    },
    upload: {
      selectFromGallery: "Wybierz z galerii",
      changeImage: "Zmień obraz",
      uploadYourImage: "Wgraj swoje zdjęcie",
  ...
  en: {
    ...
    navigation: {
      ...
      login: "Login / Sign up",
      create: "Create",
      recentVisualizations: "Recent visualizations",
      loggedInAs: "Logged in as",
      unknownUser: "Unknown user",
      tokenCount: "Token count:",
      profileAndSubscription: "Profile & Subscription",
      logout: "Log out",
      subscriptionActiveUntil: "Subscription active until:",
      subscriptionCancelledExpires: "Subscription has been canceled – will expire:",
    },
    generationProgress: {
      ...
      warmup: "Warming up...",
      andItTakes: "And it's been running for:",
      warmupDescription: "according to some, is the most important part of training. For our AI model too, because",
      warmupImportant: "it takes about 95% of the total time!",
      warmupWait: "It usually takes from a few seconds to even 5-10 minutes. Just be patient!",
      visualizingDescription: "starts right after the warm-up and will only take a few seconds.",
      interruptedDescription: "visualization generation. Don't worry, we won't charge tokens! Try again in a moment.",
