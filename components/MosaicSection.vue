      ...
      <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
        <div class="sm:max-w-lg">
            <h3 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                                ...
                                </span> Pomocnik <span class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sunsetOrange-500 to-sunsetOrange-800">przedRemontowy</span>
                                <br>
                            </h3>
                            <p class="mb-4 text-xl font-light tracking-tight text-white sm:mt-5 sm:text-xl lg:text-lg xl:text-2xl">
                                - Dzięki wizualizacjom, zobaczysz jak wybrane style, kolory i meble komponują się z Twoim pomieszczeniem -<span class="bg-sunsetOrange-500 font-semibold text-white leading-6"> zanim podejmiesz  ostateczną decyzję.</span><br/><br/>
