            ...
            <div class="flex flex-wrap items-center justify-center w-full text-center">
                <div class="w-full p-4 md:w-1/2 lg:w-1/3">
                    <div class="flex flex-col rounded-xl bg-white  text-black pb-4 shadow-2xl">
                        ...
                        <!-- <NuxtLink to=""> -->
                            <UButton @click="navigate(`https://buy.stripe.com/9AQ6pSdVyaMxeA028e?client_reference_id=${user?.id}`)" variant="solid" class="mt-4 focus:shadow-outline focus:outline-nonetracking-wide font-semibold bg-sunsetOrange-500 hover:bg-sunsetOrange-700 text-gray-100 py-4 rounded-lg transition-all duration-300 ease-in-out text-lg px-4 flex justify-center mx-8">
                ...
                <div class="w-full p-4 md:w-1/2 lg:w-1/3">
                    <div class="flex flex-col rounded-xl bg-white  text-black pb-4 shadow-2xl">
                        ...
                        <UButton @click="navigate(`https://buy.stripe.com/bIY3dGdVy8EpgI8fZ3?client_reference_id=${user?.id}`)" variant="solid" class="mt-4 focus:shadow-outline focus:outline-nonetracking-wide font-semibold bg-sunsetOrange-500 hover:bg-sunsetOrange-700 text-gray-100 py-4 rounded-lg transition-all duration-300 ease-in-out text-lg px-4 flex justify-center mx-8">
                            <UIcon width="24" height="24" name="mdi:cart-outline" dynamic /> Kup pakiet
                        </UButton>                           
                    </div>
                </div>
