            ...
            <div class="mb-10">
                <div class="space-y-4">
                    <span
                        ...
                        1 token = 1 wizalizacja
                    </span>
                    <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl md:text-6xl">
                        <span class="sm:text-6xl">
                        </span> Twój Nowy Wystrój  <span
                            class="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-sunsetOrange-500 to-sunsetOrange-800">wnętrz</span>
                        <br>
                        na Wyciągnięcie Ręki
                    </h1>
                    <p class="text-base font-light tracking-tight text-white sm:mt-5 sm:text-xl lg:text-lg xl:text-2xl">
                        Wybierz pakiet, który najlepiej odpowiada Twoim potrzebom, doładuj swoje konto tokenami, a następnie wykorzystaj je na profesjonalne wizualizacje swoich wnętrz. Dzięki naszej pomocy, Twoje przestrzenie nabiorą nowego, wyjątkowego charakteru!
                    </p>
                </div>
            </div>
            <div class="flex flex-wrap items-center justify-center w-full text-center">
                    ...
                    <div class="flex flex-col rounded-xl bg-white  text-black pb-4 shadow-2xl">
                        <div class="py-5 text-sunsetOrange-500 bg-white rounded-xl">
                            ...
                            <p class="text-5xl font-bold pb-0">
                                2zł co 1 dzień<span class="text-2xl">zł</span>
                            </p>
                            <span
                        class="rounded-xl uppercase bg-sunsetOrange-500 px-3 py-0.5 text-sm font-semibold leading-5 text-white">
                            111
                        ...
                        <!-- <NuxtLink to=""> -->
                            <UButton @click="navigate(`https://buy.stripe.com/8wMbKceZCcUFajK008?client_reference_id=${user?.id}`)" variant="solid" class="mt-4 focus:shadow-outline focus:outline-nonetracking-wide font-semibold bg-sunsetOrange-500 hover:bg-sunsetOrange-700 text-gray-100 py-4 rounded-lg transition-all duration-300 ease-in-out text-lg px-4 flex justify-center mx-8">
                                <UIcon width="24" height="24" name="mdi:cart-outline" dynamic /> Subskrybuj 2zł/1 dzień
                            </UButton>
                ...
                <div class="w-full p-4 md:w-1/2 lg:w-1/3">
                    <div class="flex flex-col rounded-xl bg-white  text-black pb-4 shadow-2xl">
                        <div class="py-5 text-sunsetOrange-500 bg-white rounded-xl">
                            ...
                            <p class="text-5xl font-bold pb-0">
                                2zl/mc<span class="text-2xl">zł</span>
                            </p>
                            <span
                        class="rounded-xl uppercase bg-sunsetOrange-500 px-3 py-0.5 text-sm font-semibold leading-5 text-white">
                            500 tokenów
                        ...
                        <UButton @click="navigate(`https://buy.stripe.com/bIYeWo18M6wh9fG14b?client_reference_id=${user?.id}`)" variant="solid" class="mt-4 focus:shadow-outline focus:outline-nonetracking-wide font-semibold bg-sunsetOrange-500 hover:bg-sunsetOrange-700 text-gray-100 py-4 rounded-lg transition-all duration-300 ease-in-out text-lg px-4 flex justify-center mx-8">
                ...
                <div class="w-full p-4 md:w-1/2 lg:w-1/3">
                    <div class="flex flex-col rounded-xl bg-white  text-black pb-4 shadow-2xl">
                        ...
                        <UButton @click="navigate(`https://buy.stripe.com/28o15yaJm7AlajK6os?client_reference_id=${user?.id}`)" variant="solid" class="mt-4 focus:shadow-outline focus:outline-nonetracking-wide font-semibold bg-sunsetOrange-500 hover:bg-sunsetOrange-700 text-gray-100 py-4 rounded-lg transition-all duration-300 ease-in-out text-lg px-4 flex justify-center mx-8">
                            <UIcon width="24" height="24" name="mdi:cart-outline" dynamic /> Kup pakiet
                        </UButton>
                    </div>
                </div> -->
